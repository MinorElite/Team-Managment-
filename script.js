...
//inquirer for prompting for response
...
// templates 
const generateTemplate = require('./src/html-template.js');
...
//starting prompts for user to input data
...
// need to make website that deploys teamembers info when asked
// generate a html file with teammembers skills and abillites
// write code that can be used in command prompt to use and generate file dispalying
// names and stuff
// look at example for the rpg character should help with past due hw
// 